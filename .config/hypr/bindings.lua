...
hl.bind("SUPER + SHIFT + LEFT", hl.dsp.send_shortcut({ mods = "SHIFT", key = "HOME" }), { description = "Send SHIFT+HOME" })
hl.bind("SUPER + SHIFT + RIGHT", hl.dsp.send_shortcut({ mods = "SHIFT", key = "END" }), { description = "Send SHIFT+END" })
...
hl.bind("SUPER + SHIFT + UP", hl.dsp.send_shortcut({ mods = "SHIFT", key = "PRIOR" }), { description = "Send SHIFT+PAGE UP" })
hl.bind("SUPER + SHIFT + DOWN", hl.dsp.send_shortcut({ mods = "SHIFT", key = "NEXT" }), { description = "Send SHIFT+PAGE DOWN" })
...
o.bind("SUPER + CTRL + SHIFT + ALT + B", "Browser", "omarchy-launch-or-focus helium uwsm app -- helium-browser --enable-features=UseOzonePlatform --ozone-platform=wayland")
...
o.bind("SUPER + CTRL + SHIFT + ALT + Y", "YouTube Kids", "omarchy-launch-or-focus-webapp \"YouTube Kids\" \"https://youtubekids.com/\"")
